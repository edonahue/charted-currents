...
| **Flota Route Preserved** | Distorted | **Markings preserved within retained chart field** | Eastward markings truncated |
...
*Note on population difference*: Candidate C covers 13 points spanning the entire map plate, including peripheral anchors (Charles Town, SC, St. Augustine, FL, and Bridgetown, Barbados). Candidate F1 is restricted to 10 points within the inner Caribbean basin. The headline LOOCV RMSEs (107.68 km vs 101.16 km) evaluate different geographic extents.
...
| **LOOCV Median Error** | **86.99 km** | 99.41 km | **-12.42 km** (C is lower) |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `gcp_moll_san_juan` | San Juan, Puerto Rico | **51.63 km** | 109.84 km | **-58.21 km** | Candidate C vastly superior; F1 pulls Puerto Rico ~58 km too far east |
| `gcp_moll_portobelo` | Portobelo, Panama | **59.70 km** | 99.41 km | **-39.71 km** | Candidate C aligns Darien / Panama isthmus markedly better |
| `gcp_moll_cartagena` | Cartagena, Colombia | **79.22 km** | 96.47 km | **-17.25 km** | Candidate C fits South American coastline better |
| `gcp_moll_cabo_san_antonio` | Cabo San Antonio, Cuba | **46.38 km** | 63.46 km | **-17.08 km** | Candidate C fits western Cuba tip better |
...
### 5.4 Regional Derivative Specification (Candidate F1)

To support complete empirical audit and visual review, the regional Candidate F1 rectified derivative was built and checked in:
* **Asset Path**: `public/assets/visuals/review/moll-west-indies-1715-f1-regional.webp`
...
5. **Hispaniola / Puerto Rico** (`[-68.0, 18.5]`, z6.0):
   ...
   - *Candidate F1*: Degrades Puerto Rico significantly (LOOCV 109.84 km), pulling the island ~58 km too far east into the Anegada Passage.
...
7. **Cartagena / Portobelo** (`[-77.5, 10.0]`, z6.2):
   - Candidate C is visibly superior across both Tierra Firme anchorages (Portobelo: 59.70 km vs 99.41 km for F1; Cartagena: 79.22 km vs 96.47 km for F1). In F1, the Isthmus of Panama and Darien coast are displaced north-eastward.
8. **Barbados / Eastern Edge** (`[-59.62, 13.1]`, z7.0):
   - Candidate C firmly retains Bridgetown (171.68 km LOOCV) and the full Windward chain. Candidate F1 clips the outer shelf and displaces the Lesser Antilles eastward.
...
1. **Common-Core Statistical Equivalence**: On the exact same 10 Caribbean basin points, out-of-sample LOOCV RMSE is effectively tied ($102.07\text{ km}$ for C vs $101.16\text{ km}$ for F1, delta $0.91\text{ km}$). Candidate C achieves **lower mean error** ($93.14\text{ km}$ vs $96.50\text{ km}$) and **lower median error** ($86.99\text{ km}$ vs $99.41\text{ km}$) across the common core.
2. **Geometric Regularity**: Candidate C preserves true graticule proportions (3241 warped height lines), avoiding the unconstrained 9% vertical over-stretching (3533 lines) produced by Candidate F1.
...
* **Regional Review Visual Asset (Candidate F1)**: `public/assets/visuals/review/moll-west-indies-1715-f1-regional.webp`
  - Dimensions: $2560 \times 1562\text{ px}$ (intermediate warped TIFF: $5787 \times 3533\text{ px}$)
  - File Size: $892,668\text{ bytes}$
  - SHA-256: `10cfb9cad6b9f51e4cd5cb0c458740be4084ee7c274697975ec822aed45d9142`
