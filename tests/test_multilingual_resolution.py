...
class TestMultilingualResolution(unittest.TestCase):
    ...
    def test_havana_multilingual_attestations(self):
        """Verify Havana preserves both English, Spanish, and historical map attestations without mutation."""
        ...
        self.assertGreaterEqual(len(attestations), 3, "Havana must have at least 3 distinct source attestations")
    ...
    def test_devotional_tokens_not_deleted(self):
        """Verify full devotional names are preserved without dropping religious tokens."""
