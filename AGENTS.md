...
Read `GEMINI.md` first. Use `docs/AGENT_CONTEXT_INDEX.md` to load only task-relevant context rather than the entire documentation tree.
...
For local Antigravity setup, use `docs/ANTIGRAVITY_SETUP.md`. For deployment readiness/verification, use `docs/CLOUDFLARE_DEPLOYMENT.md`.
