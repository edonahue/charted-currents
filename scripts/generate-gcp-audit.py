...
EXCLUDED_CANDIDATES = [
    ...
    },
    {
        ...
        "rejection_rationale": (
            "Bermuda is preserved unmasked in the main chart field. However, in Moll's 1715 engraving (as in contemporary "
            "early 18th-century cartography prior to marine chronometers), Bermuda was plotted ~250 km too far west "
            "relative to the North American coastline. Using it as an active affine control would distort the continental "
            "coastline and Greater Antilles."
        )
    },
    {
