...
def main() -> None:
    ...
    manifest = {
        ...
        "known_caveats": [
            ...
            "TIPOMEDIDA IDs start at 1; for MEDIDAS=0 no positive TIPOMEDIDA reference resolves in reference join.",
            "For CANTIDAD=0 no positive quantity value is displayed by the project; raw zero is strictly preserved.",
